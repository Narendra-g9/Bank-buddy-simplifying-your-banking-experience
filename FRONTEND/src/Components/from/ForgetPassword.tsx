...
const ForgetPAssword = ({ close }: Forget) => {
  ...
  const OTPFun = async () => {
    ...
    let value = addForm.getValues("email");
    if (value.trim() == "") {
      return;
    }
    try {
  ...
  const ChangePassword = addForm.handleSubmit(async () => {
    try {
      ...
      api.post("otpverify", {
        email: value,
        otp: addForm.getValues("OTP"),
        password: addForm.getValues("Password"),
      });
      ...
      <div className="fixed top-0 w-screen h-full bg-[#000000ad] left-0 z-[1000] component-form">
        <div className="flex justify-center items-center w-screen h-screen">
          ...
          >
            ...
            <p className=" text-center text-4xl font-bold mb-3"></p>
              ...
              <>
                <div className="mb-5">
                  ...
                  {addForm.formState.errors.OTP?.message && (
                    <p className="text-red-700 font-[500]">
                      {addForm.formState.errors.OTP?.message?.toString()}
                    </p>
                  )}
                </div>
                <div className="mb-5">
                  ...
                  {addForm.formState.errors.Password?.message && (
                    <p className="text-red-700 font-[500]">
                      {addForm.formState.errors.Password?.message?.toString()}
                    </p>
                  )}
                </div>
