...
import { BankAccount } from "./Transactions";
              ...
              <div className="">
                ...
                <div className="mb-4 ">
                  <p>
                    ...
                    {personalDetails.accUser.firstname}
                  </p>
                  <p>
                    <strong>Last Name:</strong>{" "}
                    {personalDetails?.accUser.lastname}
                  </p>
                  <p>
                  ...
                  <p>
                    <strong>Phone:</strong>{" "}
                    {personalDetails?.accUser.phoneNumber}
                  </p>
                  <p>
